...
internal static class RiverShaderCompileTests
{
    public static void RunAll()
    {
        ...
        TestHarness.Run("water refraction capture shader compiles through stride effect compiler", () => CompileShader("WaterRefractionCapture"));
    }
    ...
    private static IEnumerable<string> EnumerateSourceDirectories(string repositoryRoot, string strideSourceRoot)
    {
        ...
        yield return Path.Combine(repositoryRoot, "Terrain", "Effects", "Water");
