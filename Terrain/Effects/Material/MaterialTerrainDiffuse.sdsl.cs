...
namespace Terrain
{
    ...
    {
        public static readonly ObjectParameterKey<Texture> DetailIndexMapArray = ParameterKeys.NewObject<Texture>();
        public static readonly ObjectParameterKey<Texture> DetailWeightMapArray = ParameterKeys.NewObject<Texture>();
        public static readonly ObjectParameterKey<SamplerState> MaterialIndexSampler = ParameterKeys.NewObject<SamplerState>();
        public static readonly ObjectParameterKey<Texture> MaterialDiffuseHeightArray = ParameterKeys.NewObject<Texture>();
