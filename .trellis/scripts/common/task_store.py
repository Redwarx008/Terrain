...
def cmd_create(args: argparse.Namespace) -> int:
    ...
    if seeded_jsonl:
        ...
        print("  3. Run: pythontask.py start <dir>", file=sys.stderr)
    else:
        print("  2. Run: pythontask.py start <dir>", file=sys.stderr)
    print("", file=sys.stderr)
...
def cmd_set_branch(args: argparse.Namespace) -> int:
    ...
    if not branch:
        ...
        print("Usage: pythontask.py set-branch <task-dir> <branch-name>")
        return 1
...
def cmd_set_base_branch(args: argparse.Namespace) -> int:
    ...
    if not base_branch:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: pythontask.py set-base-branch <task-dir> <base-branch>")
        print("Example: pythontask.py set-base-branch <dir> develop")
        print()
...
def cmd_set_scope(args: argparse.Namespace) -> int:
    ...
    if not scope:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: pythontask.py set-scope <task-dir> <scope>")
        return 1
