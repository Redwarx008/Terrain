...
| `Terrain/Rendering/Water/WaterSceneLightingBinder.cs` | 共享 water scene lighting/skybox 绑定；当前供 river bottom/surface 使用，预留给 ocean 复用 |
