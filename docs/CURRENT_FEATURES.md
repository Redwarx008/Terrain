...
| 路径渲染 — 道路 | ✅ | `Terrain.Editor/Effects/PathRoadSurface.sdsl` | - |
| 路径渲染 — 河流 | ✅ | `Terrain.Editor/Effects/PathRiverSurface.sdsl` | - |
...
| 决策 | 日期 | 备注 |
|------|------|------|
| Biome 规则层体系 | 2026-05 | 待创建 ADR |
| 路径特征系统 (Road/River) | 2026-05 | 待创建 ADR |
| Avalonia UI 迁移 | 2026-04 | 待创建 ADR |
| Vic3 风格路径渲染 | 2026-05 | 待创建 ADR |
