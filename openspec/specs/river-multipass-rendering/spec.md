## Purpose
River multipass rendering defines the dedicated render feature, pass ordering, render targets, blending, and render states used to draw rivers over terrain in the editor viewport.
