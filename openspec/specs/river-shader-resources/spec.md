## Purpose
River shader resources define the shader stream contracts, shader behavior, fallback inputs, asset resources, and Stride asset workflow needed for river rendering.
