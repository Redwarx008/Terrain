...
- 宽度映射：11 种颜色（CK3 实际像素值）从 0.625 到 1.375 half-width
  - 蓝渐变（9 级）：`#00e1ff` `#00c8ff` `#0096ff` `#0064ff` `#0000ff` `#0000e1` `#0000c8` `#000096` `#000064`
  - 绿渐变（2 级）：`#007d00` `#18ce00`
  - 特殊色：Source=`#00ff00` Confluence=`#ff0000` Bifurcation=`#fffc00` Ocean=`#ff0080`
